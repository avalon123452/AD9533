...
int main(void)
{
  ...
  {
    /* USER CODE END WHILE */
//	  temp = ad5933_getTemperature(&dev1);
//	  memset(msg,0,sizeof(msg));
//	  sprintf(msg,"Temp: %.2f",temp);
//	  dmsg(msg);
//	  memset(msg,0,sizeof(msg));
//	  sprintf(msg,"start: %lx",ad5933_getReg(&dev1, AD5933_REG_FREQ_START, 3));
//	  dmsg(msg);
//	  memset(msg,0,sizeof(msg));
//	  sprintf(msg,"inc: %lx",ad5933_getReg(&dev1, AD5933_REG_FREQ_INC, 3));
//	  dmsg(msg);
//	  memset(msg,0,sizeof(msg));
//	  sprintf(msg,"num: %lx",ad5933_getReg(&dev1, AD5933_REG_INC_NUM, 2));
//	  dmsg(msg);
//	  memset(msg,0,sizeof(msg));
